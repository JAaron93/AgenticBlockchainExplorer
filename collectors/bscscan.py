...
def _get_blockchain_validator():
    ...
    if _blockchain_validator is None:
        try:
            ...
            logger.debug("BlockchainDataValidator initialized for BscscanCollector")
...
class BscscanCollector(ExplorerCollector):
    ...
    async def fetch_stablecoin_transactions(
        ...
        """Fetch stablecoin transactions from BscScan.
        
        Uses the tokentx API endpoint to get BEP-20 token transfers.
        ...
        # BscScan API parameters (compatible with Etherscan format)
        params = {
            "module": "account",
            "action": "tokentx",
